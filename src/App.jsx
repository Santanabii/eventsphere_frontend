  ...
  return (
    <Routes>
      ...
      <Route path="/organiser/dashboard" element={
        <ProtectedRoute role="organiser"><Dashboard /></ProtectedRoute>
      } />
      <Route path="/organiser/create-event" element={
        <ProtectedRoute role="organiser"><CreateEvent /></ProtectedRoute>
      } />
      <Route path="/organiser/analytics/:id" element={
        <ProtectedRoute role="organiser"><Analytics /></ProtectedRoute>
      } />
      <Route path="/scan" element={
        <ProtectedRoute role="staff"><Scanner /></ProtectedRoute>
      } />
    </Routes>
  )
}
